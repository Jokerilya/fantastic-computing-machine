  ...
  methods: {
    query() {
      ...
      if (this.queryMethod == "post") {
        ...
        this.$axios
          .get(
            `${this.url.query}?pageNo=${this.page.pageNo}&pageSize=${this.page.dataNum}`
          )
          .then(({ data: { records, total, current } }) => {
            this.dataList = records; //list;
            this.page.dataSumNum = total;
    ...
    submitForm(fn, param = {}) {
      ...
      this.$refs.addForm.validate((valid) => {
        if (valid) {
          this.$axios
            .post(this.url.add, { ...this.addForm, ...param })
            .then((data) => {
    ...
    edit(fn, param = {}) {
      this.$refs.editForm.validate((valid) => {
        if (valid) {
          this.$axios
            .post(this.url.edit, { ...this.editForm, ...param })
            .then(({ code, message }) => {
