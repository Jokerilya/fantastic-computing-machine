  ...
  <div class="content_box">
    ...
    >
      ...
      <el-table-column
        ...
        align="center"
      ></el-table-column>
      <el-table-column label="上传头像" width="200" align="center">
        <template slot-scope="scope">
          <el-image
      ...
      <el-table-column
        ...
        align="center"
      ></el-table-column>
      <el-table-column label="要求工作年限" width="180" align="center">
        <template slot-scope="scope">
    ...
    >
      <el-row>
        ...
        <el-col :span="6">岗位学历要求：</el-col>
        <el-col :span="6">{{ detail.education }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="6">公司名称：</el-col>
        <el-col :span="6">{{ detail.name }}</el-col>
        <el-col :span="6">公司规模：</el-col>
        <el-col :span="6">{{ detail.scale }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="6">薪资范围：</el-col>
        <el-col :span="6">{{ detail.salary }}</el-col>
        <el-col :span="6">要求工作经验：</el-col>
        <el-col :span="6">{{ detail.workingYears }}年</el-col>
      </el-row>
      <el-row>
        <el-col :span="6">公司福利：</el-col>
        <el-col :span="18">{{ detail.welfare }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="6">公司地址：</el-col>
        <el-col :span="12">{{ detail.address }}</el-col>
      </el-row>
      <el-row>
        <el-col :span="6">岗位描述：</el-col>
        <el-col :span="12">{{ detail.jobDesc }}</el-col>
      </el-row>
...
<script>
import { queryPostList, handlePostStatus, getPostDetail } from "@/api/boss";
export default {
  name: "",
  data() {
    return {
  ...
  methods: {
    ...
    //弹窗打开时调用数据
    dialogopen() {
      getPostDetail(this.detailid).then((res) => {
        let obj = res.data;
        if (res.code === "000") {
          this.detail = obj;
        }
