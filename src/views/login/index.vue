<template>
  <div class="login-container">
    <el-form
      ...
      label-position="left"
    >
      <web-logo :title="{ text: webNameTit, color: '#fff', size: '30px' }" />
    ...
    <p style="color: #ccc; text-align: center; margin-top: 60px">
