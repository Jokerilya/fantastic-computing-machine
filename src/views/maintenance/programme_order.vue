	...
	<div class="app-container">
		<div class="manage-top">
			<el-form :model="searchForm" ref="ruleForm" label-width="88px" class="rule-form" label-position="right">
              ...
              <el-cascader placeholder="请选择" :options="systemData" 
                :props="{children:'list',label:'name',value:'id',checkStrictly: true}" :show-all-levels="false" @change="selelctSystem"/>
            </el-form-item>
          </el-col>
					<el-col :span="5">
...
<script>
  ...
  export default {
    ...
    methods: {
      querySelectData(){
        this.loading = true;
        this.$axios.post(this.url.querySystem).then(( {data} ) => {
