<template>
  <div class="app-container">
    <div class="select_view">
      ...
      <el-button icon="el-icon-plus" type="primary" @click="grantInit()">新增</el-button>
        <model ref="addModel" title="新增设备系统" @ok="handleSubmitForm" @close="handleClose">
          <el-form :model="addForm" :rules="rules" ref="addForm" status-icon label-width="120px" class="demo-ruleForm">
            ...
            <el-form-item label="设备系统图片" prop="icon" style="width:calc(100% - 120px)">
    ...
    <model ref="editModel" title="编辑设备系统" @ok="handleEdit" @close="resetEditForm">
