<template>
  <div class="maintenance-order-container" ref="maintenanceOrderDesc">
    <div
      ...
      title="待办事项"
    >
      <!-- openAddMessageReminderDialog(orderDetail.orderSn) -->
      <!-- <el-image
        class="todo-icon"
...
<script>
import ProcessFlow from "./components/maintenance_order_desc_copy/processFlow.vue";
import ServiceTimeline from "./components/maintenance_order_desc_copy/serviceTimeline.vue";
...
联系地址:${orderDetail.address ? orderDetail.address : "无"}`;
    ...
    async getRepairOrderDetail() {
      ...
      if (res.code == "000") {
        console.log(4727, res.data.videoList);
        console.log(4728, res.data.pictureList);
