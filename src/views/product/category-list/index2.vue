  ...
  <div class="content_box">
    ...
    <div class="select_view">
      ...
      <el-cascader style="width: 300px" v-model="queryData.categoryId" class="mg_r15 mg_t10"
        ...
        :props="categoryList" :show-all-levels="false" />
    ...
    <el-table v-loading="dataConfig.loading" border :data="dataList" class="list" ref="dragTable"
      :header-cell-style="{ color: '#666' }">
      <el-table-column label="ID" width="60" align="center" header-align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.id }}</span>
        </template>
      </el-table-column>
      <el-table-column label="商品标题" width="160" align="left" header-align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.title }}</span>
        </template>
      </el-table-column>
      <el-table-column label="供应商" width="160" align="left" header-align="center">
        <template slot-scope="scope">
