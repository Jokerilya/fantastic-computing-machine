...
import { errorMap, MockApi } from '../api/index.mock';
...
function mockFile(size, name, type) {
    ...
    if (name === void 0) { name = 'mock.jpg'; }
    if (type === void 0) { type = 'image/jpg'; }
    if (size >= 1024)
        throw new Error('the size is set too large.');
    var blob = new Blob(['1'.repeat(size * MB)], { type: type });
...
describe('test upload', function () {
    ...
    test('base Direct.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result1, _a, _b, result2, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, observablePromisify(upload(File3M, null, testToken))];
                case 1:
                    result1 = _e.sent();
                    _b = (_a = expect(result1)).toStrictEqual;
                    return [4 /*yield*/, mockApi.direct()];
                case 2:
                    _b.apply(_a, [(_e.sent()).data]);
                    return [4 /*yield*/, observablePromisify(upload(File4M, null, testToken))];
                case 3:
                    result2 = _e.sent();
    ...
    test('Direct: all api error state.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    localStorage.clear();
                                    mockApi.clearInterceptor();
                                    mockApi.setInterceptor('direct', function () { return Promise.reject(error); });
                                    return [4 /*yield*/, expect(observablePromisify(upload(File3M, null, testToken)))
                ...
                case 1:
                    ...
                    _a = __values(Object.values(errorMap)), _b = _a.next();
                    _d.label = 2;
                case 2:
    ...
    test('Resume: base.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, observablePromisify(upload(File5M, null, testToken))];
                case 1:
                    result = _c.sent();
                    _b = (_a = expect(result)).toStrictEqual;
                    return [4 /*yield*/, mockApi.uploadComplete()];
                case 2:
    ...
    test('Resume: all api error state.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    _e.label = 2;
                case 2:
                    if (!!testApiTable_1_1.done) return [3 /*break*/, 11];
                    apiName = testApiTable_1_1.value;
                    _loop_2 = function (error) {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    localStorage.clear();
                                    ...
                                    return [4 /*yield*/, expect(observablePromisify(upload(File5M, null, testToken)))
                                            .rejects.toStrictEqual(error)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                ...
                case 3:
                    ...
                    _a = (e_2 = void 0, __values(Object.values(errorMap))), _b = _a.next();
                    _e.label = 4;
                case 4:
                    if (!!_b.done) return [3 /*break*/, 7];
                    error = _b.value;
                    return [5 /*yield**/, _loop_2(error)];
                case 5:
                    _e.sent();
                    _e.label = 6;
                case 6:
