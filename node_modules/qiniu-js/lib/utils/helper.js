  ...
  return new _promise["default"](function (resolve, reject) {
    ...
    xhr.onreadystatechange = function () {
      ...
      if (xhr.status === 0) {
        ...
        reject(new _errors.QiniuNetworkError(reqId, 'network error.'));
        return;
      }
      ...
      if (xhr.status !== 200) {
        ...
        reject(new _errors.QiniuRequestError(xhr.status, reqId, message));
        return;
      }
...
function getTransform(image, orientation) {
  ...
  switch (orientation) {
    ...
    default:
      throw new _errors.QiniuError(_errors.QiniuErrorName.InvalidTransformOrientation, "orientation " + orientation + " is unavailable");
  }
}