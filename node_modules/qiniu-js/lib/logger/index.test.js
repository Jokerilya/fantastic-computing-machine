...
describe('test logger', function () {
  test('level', function () {
    ...
    infoLogger.info('test1'); // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
    // @ts-ignore

    expect(logMessage).toStrictEqual([infoLogger.getPrintPrefix('INFO'), 'test1']);
    infoLogger.warn('test2'); // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
    // @ts-ignore

    expect(warnMessage).toStrictEqual([infoLogger.getPrintPrefix('WARN'), 'test2']);
    infoLogger.error('test3'); // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
    // @ts-ignore
    ...
    warnLogger.warn('test2'); // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
    // @ts-ignore

    expect(warnMessage).toStrictEqual([warnLogger.getPrintPrefix('WARN'), 'test2']);
    warnLogger.error('test3'); // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
    // @ts-ignore
    ...
    errorLogger.error('test3'); // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
    // @ts-ignore
  ...
  test('unique id', function () {
    ...
    var last = new _index["default"]('', true, 'OFF'); // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
    // @ts-ignore
