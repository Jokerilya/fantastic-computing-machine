...
&nbsp;
    ...
    const priorityQueue = cachedHostList
      .slice().sort((hostA, hostB) =&gt; (
        hostA.getUnfreezeTime() || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> - (hostB.getUnfreezeTime() || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>
      )
&nbsp;
