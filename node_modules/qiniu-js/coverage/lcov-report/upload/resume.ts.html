...
<a name='L260'></a><a href='#L260'>260</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">4x</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (info &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >md5 === info.md5)</span> {
